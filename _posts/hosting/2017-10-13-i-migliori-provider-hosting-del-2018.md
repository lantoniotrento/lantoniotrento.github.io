...
hellobar: yes
welcomemat:   <div class="col-xs-12 text-center header"><br/><br/><h1><b>Scopri i segreti dei marketers</b></h1><h2><i>Tutto quello che devi sapere prima di lanciare il tuo business su web</i></h2><br/><br/><a href="http://eepurl.com/ckInGX" class="btn2 draw-border">Scopri</a>  <a href="#closeMofo" class="closeMofo btn2 draw-border">No Grazie</a>
